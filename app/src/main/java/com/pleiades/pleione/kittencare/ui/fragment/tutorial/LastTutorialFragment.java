...
public class LastTutorialFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.fragment_tutorial_last, container, false);

        // initialize kitten paw image view
        kittenPawImageView = rootView.findViewById(R.id.paw_tutorial_last);
